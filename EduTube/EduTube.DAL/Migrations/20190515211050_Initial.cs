    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Emoticon", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribedOnId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreatedOn = table.Column<DateTime>(nullable: false),
                    YoutubeUrl = table.Column<string>(nullable: true),
                    FilePath = table.Column<string>(nullable: true),
                    AllowComments = table.Column<bool>(nullable: false),
                    Blocked = table.Column<bool>(nullable: false),
                    Deleted = table.Column<bool>(nullable: false),
                    IvniteCode = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                    VideoVisibility = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HashTagRelationship", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DateCreatedOn = table.Column<DateTime>(nullable: false),
                    EmoticonId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "likeEmoticon.png", "Like" },
                    { 2, "dislikeEmoticon.png", "Dislike" },
                    { 3, "loveEmoticon.png", "Love" },
                    { 4, "wowEmoticon.png", "WoW" },
                    { 5, "laughtEmoticon.png", "Hahaha" },
                    { 6, "sadEmoticon.png", "Sad" },
                    { 7, "angryEmoticon.png", "Angry" }
                });
